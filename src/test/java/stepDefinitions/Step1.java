...
public class Step1 {
	...
	public void i_specify_Username_and_Password() {
		driver.findElement(By.cssSelector("input#login_field")).sendKeys("kirti-77");
		driver.findElement(By.cssSelector("input#password")).sendKeys("kirti@2720");
		// Write code here that turns the phrase above into concrete actions
	}
...
//		
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//button[contains(normalize-space(),'Sign out')])[2]")).click();
	}
}